<template>
    ...
    >
        ...
        >
            ...
            <div
                class="grid justify-center justify-items-center grid-cols-[1fr_200px] grid-rows-[150px_1fr] gap-5 p-5 my-5 w-full self-center"
            >
                <slot />
                <div
                    class="grid w-full grid-cols-1 row-span-1 gap-3 px-5 py-3 text-center bg-white rounded-md shadow-2xl"
                >
                    <Link
                        href="/dashboard"
                        :class="{
                        ...
                        class="px-4 py-2 h-[45px] rounded-md w-full text-gray-800 hover:bg-indigo-400 hover:text-white duration-200"
                        >Dashboard</Link
                    >
                    <Link
                        href="/insurance"
